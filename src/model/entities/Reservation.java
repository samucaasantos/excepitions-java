...
public class Reservation {
    ...
    public Reservation(Integer roomNumber, Date checkIn, Date checkOut) throws DomainExcepition {
        if (!checkOut.after(checkIn)) {
            throw new DomainExcepition( "Check-out date just be after check-in date");
        }
    ...
    public String toString() {
        return "Reservation: " + roomNumber + ", check-in: " +
